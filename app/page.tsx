  ...
  return (
    <main>
      ...
      <header className="site-header">
        <a className="brand" href="#top" aria-label="Greenes Repair home"><span className="brand-mark">G</span><span><strong>{siteContent.businessName}</strong><small>by {siteContent.ownerName}</small></span></a>
